...
class Likedossiers extends React.Component{
...
document.querySelectorAll('small.dossier-react-like').forEach(function (element) {
    ReactDOM.render(<Likedossiers />, element)
})
