...
/**
 * @ORM\Entity(repositoryClass="App\Repository\Articles\DTSectionsRepository")
 * @UniqueEntity("name")
 */
class DTSections
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Articles\DTArticles", mappedBy="dtsections")
     */
    private $dTArticles;
    ...
    public function removeDTArticle(DTArticles $dTArticle): self
    {
        if ($this->dTArticles->contains($dTArticle)) {
            ...
            if ($dTArticle->getDtsections() === $this) {
                $dTArticle->setDtsections(null);
            }
        }
