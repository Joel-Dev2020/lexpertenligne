...
/**
 * @ORM\Entity(repositoryClass="App\Repository\Articles\DTPartiesRepository")
 * @UniqueEntity("name")
 */
class DTParties
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Articles\DTArticles", mappedBy="dtparties")
     */
    private $dTArticles;
    ...
    public function removeDTArticle(DTArticles $dTArticle): self
    {
        if ($this->dTArticles->contains($dTArticle)) {
            ...
            if ($dTArticle->getDtparties() === $this) {
                $dTArticle->setDtparties(null);
            }
        }
