...
/**
 * @ORM\Entity(repositoryClass="App\Repository\Articles\DTCategoriesRepository")
 * @UniqueEntity("name")
 */
class DTCategories
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Articles\DTArticles", mappedBy="dtcategories")
     */
    private $dTArticles;
    ...
    public function addDTArticle(DTArticles $dTArticle): self
    {
        if (!$this->dTArticles->contains($dTArticle)) {
            ...
            $dTArticle->setDtcategories($this);
        }
    ...
    public function removeDTArticle(DTArticles $dTArticle): self
    {
        if ($this->dTArticles->contains($dTArticle)) {
            ...
            if ($dTArticle->getDtcategories() === $this) {
                $dTArticle->setDtcategories(null);
            }
        }
