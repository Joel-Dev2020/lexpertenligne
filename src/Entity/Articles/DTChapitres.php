...
/**
 * @ORM\Entity(repositoryClass="App\Repository\Articles\DTChapitresRepository")
 * @UniqueEntity("name")
 */
class DTChapitres
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Articles\DTArticles", mappedBy="dtchapitres")
     */
    private $dTArticles;
    ...
    public function removeDTArticle(DTArticles $dTArticle): self
    {
        if ($this->dTArticles->contains($dTArticle)) {
            ...
            if ($dTArticle->getDtchapitres() === $this) {
                $dTArticle->setDtchapitres(null);
            }
        }
