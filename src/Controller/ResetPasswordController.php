...
/**
 * @Route("/reset-password", schemes={"https"})
 */
class ResetPasswordController extends AbstractController
{
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, \Swift_Mailer $mail): RedirectResponse
    {
        ...
        $message = (new \Swift_Message('Your password reset request'))
            ->setFrom('infos@lexpertenligne.com', 'Lexpertenligne')
            ->setTo($user->getEmail())
            ->setBody($this->renderView('security/reset_password/email.html.twig', [
        ...
        /*$email = (new TemplatedEmail())
            ->from(new Address('spiral@spiral.ci', 'Spiral Office & Home'))
            ->to($user->getEmail())
